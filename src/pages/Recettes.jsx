...
export default function Recettes() {
  ...
  useEffect(() => {
    const loadUser = async () => {
      ...
      if (user && user.specialite !== 'admin' && user.specialite !== 'ophtalmologue') {
  ...
  if (!currentUser || (currentUser.specialite !== 'admin' && currentUser.specialite !== 'ophtalmologue')) {
    return (
  ...
  const cotationsFiltrees = isAdmin 
    ? toutesLesCotations 
    : toutesLesCotations.filter(c => c.created_by === currentUser.email);
    ...
    const htmlContent = `
      ...
      <body onload="window.print(); window.close();">
        <div class="header">
          ...
          <div class="subtitle">${currentUser.full_name} - ${format(new Date(), 'dd/MM/yyyy')}</div>
        </div>
